...
@section('content')
    ...
    <div class="container pad-on-handheld">
        {!! Form::open(['route' => 'install', 'autocomplete' => 'off']) !!}
            <div class="row">
                <div class="column-half vertical">
                    ...
                    <div class="control">
                        ...
                        <div class="control-field sixty">
                            {!! Form::text('host', $host) !!}
                            <div class="help-text">Enter the domain or host information for this account (e.g. somedomain.com or 192.168.1.1:8000).</div>
                        </div>
                    </div>
