 ...
 *
 *
 * Extremely minor modifications for Shift, so that we can pass in
 * the ApiKey as a param of allow();
 *
 * Original file from:
 * http://auz.github.io/HP_BlackList/
 */

class HoneyPotBlacklist
{
    /**
     ...
     * @return boolean
     */
    public static function allow($ip, $apiKey) {
        $blr = self::check($ip, $apiKey);
