...
var DefaultControllers = {
	 ...
	 */
	index: function($rootScope, $scope, $filter, Seeker, Deletism, Filter, Resource) {
	 ...
	 */
	create: function($rootScope, $scope, $filter, Resource) {
	 ...
	 * }
	 */
	update: function($rootScope, $scope, $filter, resource) {
		return function() {
