...
namespace DoctrineProxies\__CG__\Tectonic\Shift\Modules\Fields\Entities;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Field extends \Tectonic\Shift\Modules\Fields\Entities\Field implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'group', 'resource', 'type', 'fieldTitle', 'fieldCode', 'label', 'options', 'validation', 'settings', 'required', 'registration', 'order', '' . "\0" . 'Tectonic\\Shift\\Modules\\Fields\\Entities\\Field' . "\0" . 'account', '' . "\0" . 'Tectonic\\Shift\\Modules\\Fields\\Entities\\Field' . "\0" . 'createdAt', '' . "\0" . 'Tectonic\\Shift\\Modules\\Fields\\Entities\\Field' . "\0" . 'updatedAt');
        }
