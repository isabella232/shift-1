...
namespace DoctrineProxies\__CG__\Tectonic\Shift\Modules\Security\Entities;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Role extends \Tectonic\Shift\Modules\Security\Entities\Role implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'name', 'default', 'permissions', 'users', '' . "\0" . 'Tectonic\\Shift\\Modules\\Security\\Entities\\Role' . "\0" . 'account', '' . "\0" . 'Tectonic\\Shift\\Modules\\Security\\Entities\\Role' . "\0" . 'createdAt', '' . "\0" . 'Tectonic\\Shift\\Modules\\Security\\Entities\\Role' . "\0" . 'updatedAt', '' . "\0" . 'Tectonic\\Shift\\Modules\\Security\\Entities\\Role' . "\0" . 'deletedAt');
        }
