 ...
 */
class Domain extends \Tectonic\Shift\Modules\Accounts\Entities\Domain implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'domain', '' . "\0" . 'Tectonic\\Shift\\Modules\\Accounts\\Entities\\Domain' . "\0" . 'account', '' . "\0" . 'Tectonic\\Shift\\Modules\\Accounts\\Entities\\Domain' . "\0" . 'createdAt', '' . "\0" . 'Tectonic\\Shift\\Modules\\Accounts\\Entities\\Domain' . "\0" . 'updatedAt');
        }
     ...
     * {@inheritDoc}
     */
    public function setDomain(\Tectonic\Shift\Modules\Accounts\ValueObjects\DomainName $domain)
    {
     ...
     * {@inheritDoc}
     */
    public function setAccount(\Tectonic\Shift\Modules\Accounts\Entities\Account $account)
    {
